    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-brand" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="social-icons" style={{display: 'flex', gap: '15px', marginTop: '20px', alignItems: 'center'}}>
            ...
            <a href="https://www.swiggy.com/search?query=Kausar+Restaurant" target="_blank" rel="noreferrer" aria-label="Swiggy">
              <img src={swiggyIcon} alt="Swiggy" width="24" height="24" style={{ filter: 'brightness(0) invert(1)',color: "var(--primary)" }} />
            </a>
          </div>
        </div>
